...
- patch_package: strict versioned multi-file inspect/dryRun/apply/verify with one-shot package capabilities, all-target staging before deterministic commits, exact pre/post fingerprints, and explicit partial/unknown classification without automatic rollback
