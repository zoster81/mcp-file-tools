...
- patch_package: strict versioned multi-file inspect/dryRun with expected content-v1 fingerprints, alias rejection, bounded preparation, per-target diffs, and aggregate pre/post evidence; initial actions never write
