...
- Current source capabilities: completed shared text-document core (R1) and completed secure filesystem walker (R2)
- Next source milestone: atomic mutation layer (R3), not implemented yet
