...
- Active milestone: R16 verified change workflows; the first source tranche adds deterministic `fingerprint_paths`, bringing the unreleased catalog to 24 tools without changing the published 2.0.0 baseline
