...
- preserve the same 23-tool catalog, allowed-directory checks, encoding behavior, limits, and error mapping as stdio;
...
- session identifiers and in-flight MCP messages;
...
MCP client
    ...
    -> shared MCP server and 23 tools
...
- complete session IDs or event IDs;
- query strings;
